...
{
    return g_ascii_strcasecmp(string, "<ALT>") == 0;
}

static inline gboolean
is_ctl (const gchar *string) {
    return g_ascii_strcasecmp(string, "<CTL>") == 0;
}
...
is_ctrl (const gchar *string) {
    return g_ascii_strcasecmp(string, "<CTRL>") == 0;
}

static inline gboolean
is_shft (const gchar *string) {
    return g_ascii_strcasecmp(string, "<SHFT>") == 0;
}

static inline gboolean
is_shift (const gchar *string) {
    return g_ascii_strcasecmp(string, "<SHIFT>") == 0;
}

static inline gboolean
is_control (const gchar *string) {
    return g_ascii_strcasecmp(string, "<CONTROL>") == 0;
}

static inline gboolean
is_release (const gchar *string) {
    return g_ascii_strcasecmp(string, "<RELEASE>") == 0;
}

static inline gboolean
is_meta (const gchar *string) {
    return g_ascii_strcasecmp(string, "<META>") == 0;
}

static inline gboolean
is_super (const gchar *string) {
    return g_ascii_strcasecmp(string, "<SUPER>") == 0;
}

static inline gboolean
is_hyper (const gchar *string) {
    return g_ascii_strcasecmp(string, "<HYPER>") == 0;
}

static inline gboolean
is_primary (const gchar *string) {
    return g_ascii_strcasecmp(string, "<PRIMARY>") == 0;
}
